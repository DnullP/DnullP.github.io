import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as s,e as l,a as e,b as n}from"./app-R-Dc1HOU.js";const t={},c=l(`<h1 id="前置准备" tabindex="-1"><a class="header-anchor" href="#前置准备"><span>前置准备</span></a></h1><ul><li>Yacc: parser的生成器</li><li>Lex: scanner的生成器</li></ul><p>在Ubuntu环境下安装对应的<code>bsion</code>和<code>flex</code></p><h1 id="基本格式" tabindex="-1"><a class="header-anchor" href="#基本格式"><span>基本格式</span></a></h1><h2 id="flex" tabindex="-1"><a class="header-anchor" href="#flex"><span>Flex</span></a></h2><div class="language-lex line-numbers-mode" data-ext="lex" data-title="lex"><pre class="language-lex"><code>%{
#include &quot;y.tab.h&quot;
letter [a-zA-Z]
digit [0-9]
...
E   :   E &#39;+&#39; E         { $$ = $1 + $3; }
  ...
  Reduce derivation
    ...
    ↳ 3: E            &#39;+&#39; E
         ↳ 8: &#39;-&#39; E •
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),o=[c,d,r];function m(u,v){return i(),s("div",null,o)}const y=a(t,[["render",m],["__file","CH4-yacc-and-lex.html.vue"]]),h=JSON.parse(`{"path":"/posts/compiler/CH4-yacc-and-lex.html","title":"Yacc和Lex的基本使用","lang":"zh-CN","frontmatter":{"title":"Yacc和Lex的基本使用","tag":["编译原理","词法分析","语法分析","语义分析","中间代码生成","代码"],"categories":["compiler"],"math":true,"date":"2023-05-03T00:00:00.000Z","description":"前置准备 Yacc: parser的生成器 Lex: scanner的生成器 在Ubuntu环境下安装对应的bsion和flex 基本格式 Flex 如上%%将程序分为三个区域: 第一个区域是声明, 包括了头文件的声明和正则定义 第二个区域是词法分析规则 第三个区域是辅助函数 通过%{和%}括起来的部分会原封不动的复制到生成的lex.yy.c中, 一般...","head":[["meta",{"property":"og:url","content":"https://Dnullp.github.io/posts/compiler/CH4-yacc-and-lex.html"}],["meta",{"property":"og:site_name","content":"Dnull's Blog"}],["meta",{"property":"og:title","content":"Yacc和Lex的基本使用"}],["meta",{"property":"og:description","content":"前置准备 Yacc: parser的生成器 Lex: scanner的生成器 在Ubuntu环境下安装对应的bsion和flex 基本格式 Flex 如上%%将程序分为三个区域: 第一个区域是声明, 包括了头文件的声明和正则定义 第二个区域是词法分析规则 第三个区域是辅助函数 通过%{和%}括起来的部分会原封不动的复制到生成的lex.yy.c中, 一般..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"Dnull"}],["meta",{"property":"article:tag","content":"编译原理"}],["meta",{"property":"article:tag","content":"词法分析"}],["meta",{"property":"article:tag","content":"语法分析"}],["meta",{"property":"article:tag","content":"语义分析"}],["meta",{"property":"article:tag","content":"中间代码生成"}],["meta",{"property":"article:tag","content":"代码"}],["meta",{"property":"article:published_time","content":"2023-05-03T00:00:00.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Yacc和Lex的基本使用\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-05-03T00:00:00.000Z\\",\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Dnull\\",\\"url\\":\\"https://Dnullp.github.io\\"}]}"]]},"headers":[{"level":2,"title":"Flex","slug":"flex","link":"#flex","children":[]},{"level":2,"title":"Bsion","slug":"bsion","link":"#bsion","children":[]}],"git":{},"readingTime":{"minutes":2.78,"words":833},"filePathRelative":"posts/compiler/CH4-yacc-and-lex.md","localizedDate":"2023年5月3日","excerpt":"\\n<ul>\\n<li>Yacc: parser的生成器</li>\\n<li>Lex: scanner的生成器</li>\\n</ul>\\n<p>在Ubuntu环境下安装对应的<code>bsion</code>和<code>flex</code></p>\\n<h1>基本格式</h1>\\n<h2>Flex</h2>\\n<div class=\\"language-lex\\" data-ext=\\"lex\\" data-title=\\"lex\\"><pre class=\\"language-lex\\"><code>%{\\n#include \\"y.tab.h\\"\\nletter [a-zA-Z]\\ndigit [0-9]\\nword {letter}({letter}|{digit})*\\n%}\\n\\n%%\\n[0-9]+          { yylval = atoi(yytext); return T_NUM; }\\n[-/+*()\\\\n]      { return yytext[0]; }\\n[ \\\\t\\\\n]         ;\\n.               { yyerror(\\"Unknown character\\"); }\\n%%\\n\\nint yywrap(void) { \\n    return 1;\\n}\\n</code></pre></div>","autoDesc":true}`);export{y as comp,h as data};
